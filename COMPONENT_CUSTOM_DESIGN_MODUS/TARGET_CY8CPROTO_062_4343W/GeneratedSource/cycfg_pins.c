...
#endif //defined (CY_USING_HAL)
const cy_stc_gpio_pin_config_t ioss_0_port_13_pin_7_config = 
{
	.outVal = 1,
	.driveMode = CY_GPIO_DM_ANALOG,
	.hsiom = ioss_0_port_13_pin_7_HSIOM,
	.intEdge = CY_GPIO_INTR_DISABLE,
	.intMask = 0UL,
	.vtrip = CY_GPIO_VTRIP_CMOS,
	.slewRate = CY_GPIO_SLEW_FAST,
...
#if defined (CY_USING_HAL)
	const cyhal_resource_inst_t ioss_0_port_13_pin_7_obj = 
	{
		.type = CYHAL_RSC_GPIO,
		.block_num = ioss_0_port_13_pin_7_PORT_NUM,
		.channel_num = ioss_0_port_13_pin_7_PIN,
	};
#endif //defined (CY_USING_HAL)
...
#if defined (CY_USING_HAL)
	cyhal_hwmgr_reserve(&ioss_0_port_13_pin_7_obj);
#endif //defined (CY_USING_HAL)
